...
CardDataMaster.propTypes = (_CardDataMaster$propT = {
  classes: _propTypes2.default.object.isRequired,
  subtitle: _propTypes2.default.string,
  overhead: _propTypes2.default.string,
  title: _propTypes2.default.string,
  cover: _propTypes2.default.string
}, _defineProperty(_CardDataMaster$propT, 'cover', _propTypes2.default.string), _defineProperty(_CardDataMaster$propT, 'overheadColor', _propTypes2.default.oneOf(['secondary', 'default', 'primary'])), _defineProperty(_CardDataMaster$propT, 'contentMain', _propTypes2.default.string), _defineProperty(_CardDataMaster$propT, 'actions', _propTypes2.default.node), _defineProperty(_CardDataMaster$propT, 'expandMain', _propTypes2.default.bool), _defineProperty(_CardDataMaster$propT, 'handleExpandMainClick', _propTypes2.default.func), _defineProperty(_CardDataMaster$propT, 'contentMainAdditional', _propTypes2.default.node), _defineProperty(_CardDataMaster$propT, 'className', _propTypes2.default.string), _CardDataMaster$propT);
