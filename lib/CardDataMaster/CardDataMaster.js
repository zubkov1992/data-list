...
var _teal = require('material-ui/colors/teal');
...
var styles = function styles(theme) {
  return {
    ...
    badgeColorTeal: {
      backgroundColor: _teal2.default[500],
  ...
  _createClass(CardDataMaster, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Badge2.default,
        { classes: { badge: classes.badge, colorTeal: classes.badgeColorTeal }, badgeContent: badge, color: badgeColor },
...
CardDataMaster.propTypes = {
  ...
  bradge: _propTypes2.default.string,
  badgeColor: _propTypes2.default.oneOf(['secondary', 'teal', 'primary']),
