  ...
  _createClass(AppBarPages, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _AppBar2.default,
        { position: 'fixed', color: 'default', className: (0, _classnames2.default)(classes.root, classNameProp) },
        _react2.default.createElement(
          _Toolbar2.default,
          null,
          onChangeSidebar && _react2.default.createElement(
          ...
          onChangeLogout && onChangeLogin && (auth ? _react2.default.createElement(
            _Button2.default,
            {
              color: 'primary',
              onClick: function onClick() {
...
AppBarPages.propTypes = {
  ...
  onChangeSidebar: _propTypes2.default.func,
  logoSrc: _propTypes2.default.string,
  auth: _propTypes2.default.bool,
  onChangeLogin: _propTypes2.default.func,
  onChangeLogout: _propTypes2.default.func,
